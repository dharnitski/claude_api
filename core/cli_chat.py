...
def convert_prompt_message_to_message_param(
    ...
    role: str = "user" if prompt_message.role == "user" else "assistant"

    content = prompt_message.content

    if isinstance(content, TextContent):
        return {"role": role, "content": content.text}  # type: ignore[typeddict-item]

    return {"role": role, "content": ""}  # type: ignore[typeddict-item]
